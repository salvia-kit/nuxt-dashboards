...
<template>
  <div class="flex flex-col flex-wrap sm:flex-row">
    <div class="mb-6 w-full pr-2 md:w-4/12">
      <div class="rounded-2xl bg-white p-4 shadow">
        <div class="flex items-center">
          ...
          <p class="ml-2 text-black">{{ title || "Total Gains" }}</p>
        </div>
    ...
    <div
      class="relative mt-8 w-full overflow-hidden rounded-xl bg-white p-4 shadow-lg md:mr-2 md:w-3/12"
    >
    ...
    <div
      class="relative mt-8 w-full overflow-hidden rounded-xl bg-white p-4 text-gray-700 shadow-lg md:ml-2 md:w-4/12"
    >
    ...
    <div
      class="relative mt-8 w-full overflow-hidden rounded-xl bg-white p-4 shadow-lg md:ml-4 md:w-4/12"
    >
